    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a class="active" href="coach.html">
              <i class="fa fa-desktop"></i>
              <span>Coach</span>
              </a>
          </li>
...
<!--
          <div style="background: none;position: absolute;left: 600px;height: 600px;width: 500px;top: 110px;text-align: center;border: 1px solid #000;">
            <h2 >Formulaire des Coachs</h2>
            <br>
            <br>
            <br>

            <input class="form-control" type="text" id="nom" placeholder="Nom" style="margin-left: 50px;margin-right: 50px;width: 400px;">
            <input class="form-control" type="text" id="prenom" placeholder="Prenom" style="margin-left: 50px;margin-right: 50px;width: 400px;">
            <input class="form-control" type="e-mail" id="mail" placeholder="Adresse mail" style="margin-left: 50px;margin-right: 50px;width: 400px;">
            <br>
            <br>
            <br>
...
-->
          <div class="main">
            ...
            <div class="txtb">
              ...
              <input type="e-mail" id="mail" placeholder="mail">
            </div>
            <br>
            <br>
            <br>
