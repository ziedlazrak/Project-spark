    ...
    <header class="header black-bg">
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="../views/login.php">Logout</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
...
<form method="POST" action="ajoutcours.php">
          <div class="main">
            ...
            <h2>Formulaire de Cours</h2>
            <div class="txtb">
              <label>Reference :</label>
              <input type="text" id="Ref" name="ref_cours" placeholder="Reference">
            </div>

            <div class="txtb">
              <label>Durée</label>
              <input type="number" id="Durée" name="dur_cours"placeholder="Entrez la Durée du cours ">
            </div>


            <div class="txtb">
              <label>Nom du Coach :</label>
              <input type="text" id="nom" name="nom_coach" placeholder="Nom du Coach">
            </div>

            <div class="txtb">
              <label>Disponibilité du Cours :</label>
              <input id="check1" type="radio" name="dispo" style="z-index: 1;position: absolute;left: 0px;"/>
              <label for="q0r6" style="z-index: 0;">disponible</label> 
              <input  id="check2" type="radio" name="dispo" style="z-index: 1;position: absolute;left: 0px;"/>
